...
/*TIPS*/
/*
insert into codewars.tips (id, exercise_id, tip, price) values (default, 1, '[-]Vous pouvez vérifier vos calculs depuis un <a href="http://www.banqueducanada.ca/taux/taux-de-change/convertisseur-de-devises-taux-du-jour/" target="_blank">convertisseur en ligne</a>. ', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 2, '[-] Attention ! les litres peuvent être flottant (avec une décimale).', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 6, '[-] Vous pouvez tester avec un <a href="http://www.calculconversion.com/calcul-taxes-tps-tvq.html" target="_blank">calculateur de taxes en ligne</a>. ', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 7, '[-] Utilisez l''objet Date de Java', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 10, '[-]Utilisez adéquatement une boucle for pour simplifier au maximum votre code.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 16, '[-] Référez-vous aux constantes incluses dans les Classes utilitaires de chaque type primitif (classe d''enrobage).', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 17, '[-] Utilisez une variable compteur pour savoir combien d''éléments ont été réellement lus depuis le fichier et chargés dans le tableau;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 17, '[-] Utilisez la classe Scanner pour effectuer votre lecture;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 17, '[-] Placez le fichier à la racine de votre projet Java.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 18, '[-] Utilisez des tableaux prédéfinis dans votre programme principal pour tester votre fonction;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 18, '[-] Faites-vous une fonction <code>afficherTableau</code> que vous pourrez réutiliser dans vos autres programmes nécessitant l''affichage d''un tableau.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 19, '[-] Utilisez des tableaux prédéfinis dans votre programme principal pour tester votre fonction;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 19, '[-] Faites-vous une fonction <code>afficherTableau</code> que vous pourrez réutiliser dans vos autres programmes nécessitant l''affichage d''un tableau.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 20, '[-] Charger tous les mots du fichier dans un tableau puis sélectionnez un indice au hasard dans ce tableau pour obtenir le mot à trouver;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 20, '[-] Utilisez une variable compteur pour savoir combien d''éléments ont été réellement lus depuis le fichier et chargés dans le tableau;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 20, '[-] Utilisez la classe <code>Scanner</code> pour effectuer votre lecture;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 20, '[-] Le fichier se trouve à la racine du projet Java;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 20, '[-] Utilisez la classe <code>Random</code> ou la méthode <code>Math.random()</code>.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 21, '[-] Utilisez des tableaux prédéfinis dans votre programme principal pour tester votre fonction;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 21, '[-] Faites-vous une fonction <code>afficherTableau</code> que vous pourrez réutiliser dans vos autres programmes nécessitant l''affichage d''un tableau.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 22, '[-] Utilisez des tableaux prédéfinis dans votre programme principal pour tester votre fonction;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 22, '[-] Faites-vous une fonction <code>afficherTableau</code> que vous pourrez réutiliser dans vos autres programmes nécessitant l''affichage d''un tableau.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 23, '[-] Utilisez des tableaux prédéfinis dans votre programme principal pour tester votre fonction;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 23, '[-] Faites-vous une fonction <code>afficherTableau</code> que vous pourrez réutiliser dans vos autres programmes nécessitant l''affichage d''un tableau.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 24, '[-] Utilisez des tableaux prédéfinis dans votre programme principal pour tester votre fonction;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 24, '[-] Faites-vous une fonction <code>afficherTableau</code> que vous pourrez réutiliser dans vos autres programmes nécessitant l''affichage d''un tableau.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 25, '[-] Utilisez des tableaux prédéfinis dans votre programme principal pour tester votre fonction;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 25, '[-] Faites-vous une fonction <code>afficherTableau</code> que vous pourrez réutiliser dans vos autres programmes nécessitant l''affichage d''un tableau.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 26, '[-] Utilisez des tableaux prédéfinis dans votre programme principal pour tester votre fonction;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 26, '[-] Si le tableau contient un nombre pair d''éléments, la médiane sera la moyenne des deux nombres du milieu;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 26, '[-] Vous pouvez utiliser la méthode printf pour gérer la précision de 2 chiffres après le point;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 26, '[-] Utilisez des variables de type double pour vos calculs.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 27, '[-]Effectuez une trace d''exécution sur papier pour bien comprendre l''algorithme avant de commencer à programmer;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 27, '[-] Utilisez des tableaux prédéfinis dans votre programme principal pour tester votre fonction;', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 27, '[-] Faites-vous une fonction <code>afficherTableau</code> que vous pourrez réutiliser dans vos autres programmes nécessitant l''affichage d''un tableau.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 28, '[-] Utilisez la méthode <i>printf</i> pour effectuer un formatage clair.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 29, '[-] Testez dans un premier temps ce qui se produit lorsqu''il y a débordement.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 29, '[-] Prenez le temps d''analyser, sur papier, le résultat d''un calcul lorsqu''il y a un débordement.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 30, '[-] Il existe probablement quelque chose en Java qui permet de faire cette conversion en une ligne de code.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 31, '[-] Forcez-vous à faire une seule classe propre. Basez-vous sur l''exemple fait en classe.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 31, '[-] Vous pouvez consulter la page de revenu Québec pour le calcul de la taxe en fonction des paramètres de cette année : <a href="http://www.revenuquebec.ca/fr/entreprise/taxes/tvq_tps/calcul-taxes.aspx" target="_blank">www.revenuquebec.ca</a>.', 0);
insert into codewars.tips (id, exercise_id, tip, price) values (default, 33, '[-] Créer une classe Console qui implémente les commandes. Garder une propriété qui conserve le répertoire courant (pwd) de l''utilisateur. Lorsque l''utilisateur se déplace avec la commande "cd", modifier simplement la propriété qui représente le répertoire courant (pwd).', 0);
*/
/*ITEMS*/
...
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 21, true, false, '', '/home/dtucker/www/code-wars/uploads/ir3vf7nhJxX6hyi1ydfBT8Fj.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 32, true, false, '', '/home/dtucker/www/code-wars/uploads/tqsl9HtmyYY9PhP9q2iJgPOv.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 66, true, false, '', '/home/dtucker/www/code-wars/uploads/b8eNoNb4f8Mmo1AKynOWA4fC.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 24, true, false, '', '/home/dtucker/www/code-wars/uploads/qSo8UzARYaahCuBfDJK0u2iI.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 51, true, false, '', '/home/dtucker/www/code-wars/uploads/cvUW0LjhFGkBlZO0roV0uAMF.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 43, true, false, '', '/home/dtucker/www/code-wars/uploads/reB5MVpgsB4fPziXSLeoQxuj.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 31, true, false, '', '/home/dtucker/www/code-wars/uploads/udVR4CB7HupOIOR8GdZAveoe.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 37, true, false, '', '/home/dtucker/www/code-wars/uploads/9l4IT0HVuTNlBPIiJ2Igv594.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1326333, 37, true, false, '', '/home/dtucker/www/code-wars/uploads/gilgFboXYBWRWUXIzYe45BtI.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2146790, 21, true, false, '', '/home/dtucker/www/code-wars/uploads/djlBKXjyaAGdMS4X5Qo46FEB.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1326333, 51, true, false, '', '/home/dtucker/www/code-wars/uploads/D2b0O3s2gzvpj5A4m4Lc7qNo.zip', now(), 'Je fais de l''insomnie.', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1326333, 32, true, false, '', '/home/dtucker/www/code-wars/uploads/AAuWzXBQv2c1fJBvpg3Pb0xt.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2167015, 21, true, false, '', '/home/dtucker/www/code-wars/uploads/zwc6rhJG6MST2bFDtdhJdalv.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 50, true, false, '', '/home/dtucker/www/code-wars/uploads/LDrKjvS2zcqBhSpCBNxQentf.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2167015, 36, true, false, '', '/home/dtucker/www/code-wars/uploads/yDqzFjX7Fk403CLSpeq42gNu.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2167015, 66, true, false, '', '/home/dtucker/www/code-wars/uploads/RNkuyq5oVrwwsPjtOsZZXCz1.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2167015, 51, true, false, '', '/home/dtucker/www/code-wars/uploads/JIYMrWkaNk7HCYWoDrpARRba.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2146790, 25, true, false, '', '/home/dtucker/www/code-wars/uploads/7Dy9QXWgBOnq5pQnb9bYexjv.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2134218, 19, true, false, '', '/home/dtucker/www/code-wars/uploads/0PL8kVcaYJyRrpGRAnfk86Lq.java', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2134218, 21, true, false, '', '/home/dtucker/www/code-wars/uploads/asfocZXVzsj2FUlUcpY2cs5a.java', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2134218, 24, true, false, '', '/home/dtucker/www/code-wars/uploads/w0jCoi2gysx4Ta317k2N4bmn.java', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2134218, 25, true, false, '', '/home/dtucker/www/code-wars/uploads/56bBZjKBuXmpx3xEZrPQIQ71.java', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2134218, 31, true, false, '', '/home/dtucker/www/code-wars/uploads/aosflqlLPjunzehy0neEw6nf.java', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1448676, 19, true, false, '', '/home/dtucker/www/code-wars/uploads/G6cI1sEaMqKpu2abUEkzDMuZ.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1448676, 24, true, false, '', '/home/dtucker/www/code-wars/uploads/zQO7n5GjdKlXKksVpzqhb3BN.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1448676, 25, true, false, '', '/home/dtucker/www/code-wars/uploads/WmQcAhlFKp0vVP9SoC5kaFhl.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1448676, 32, true, false, '', '/home/dtucker/www/code-wars/uploads/3zUxyDBwB8MjaFqXMjwPI414.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1448676, 36, true, false, '', '/home/dtucker/www/code-wars/uploads/bAHk7svNei3NySv0h4dPRIFg.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1448676, 37, true, false, '', '/home/dtucker/www/code-wars/uploads/gORZZTk0trTzJLUvjXwG39T3.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1448676, 51, true, false, '', '/home/dtucker/www/code-wars/uploads/qwdDMKuCluVcQtf3klfK5SeR.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1448676, 43, true, false, '', '/home/dtucker/www/code-wars/uploads/K6RY6qXjRUoVzm9nQ7nExmfc.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1448676, 46, true, false, '', '/home/dtucker/www/code-wars/uploads/SfZIw2GnjFEcyks6kHKWzO4F.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1448676, 50, true, false, '', '/home/dtucker/www/code-wars/uploads/OzO2RaQKXchpDkMde5hjPc0W.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1448676, 66, true, false, '', '/home/dtucker/www/code-wars/uploads/1uyM0KG4jwxh5yemAvVgORUF.zip', now(), '', null);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 6176471, 69, true, false, '', '/home/dtucker/www/code-wars/uploads/kBRdQefL0ImqiLvnxvslE6C9.zip', now(), '', null);

insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 3, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1448676, 3, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 6176471, 3, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2134218, 3, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2136072, 3, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2154718, 3, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2183098, 3, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 6176553, 3, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2178274, 3, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2146790, 3, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1929852, 3, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2144667, 3, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2167015, 3, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 8, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 6176471, 8, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2134218, 8, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 6176553, 8, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1326333, 8, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2178274, 8, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 19, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 6176471, 19, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2146790, 19, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1929852, 24, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 25, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 6176471, 25, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 28, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1448676, 28, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2134218, 28, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2136072, 28, true, true, 'Pas si simple que ça ...', '', now(), '', 0);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2183098, 28, true, true, 'Pas si simple que ça ....', '', now(), '', 0);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 1326333, 28, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 36, true, true, '', '', now(), '', 1);
insert into codewars.studentexercise(id, student_da, exercise_id, completed, corrected, comments, dir_path, submit_date, student_comment, is_good) values(default, 2029684, 54, true, true, '', '', now(), '', 1);
